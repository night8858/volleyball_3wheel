...
extern s_ops9_data_t ops9_data;           // 接发球视觉数据结构体
...
void debug_task(void const *argument)
{
  ...
  while (1)
  {
    ...
    // 调试击球电机
    //  uart_dma_printf(&huart1, "%4.3d, %4.3f ,%4.3f ,%4.3d ,%4.3f ,%4.3f\n",
    //                  motor_Date[4].back_motor_speed,
    //                  motor_Date[4].out_current,
    //                  motor_Date[4].serial_motor_ang,
    //                  motor_Date[5].back_motor_speed,
    //                  motor_Date[5].out_current,
    //                  motor_Date[5].serial_motor_ang);
    ...
    // 调试陀螺仪补正
    // uart_dma_printf(&huart1, "%4.3f,%4.3f, %4.3f ,%4.3f,%4.3f\n",
    //                 chassis_control.chassis_yaw_set,
    //                 IMU_All_Value.yaw.yawAng,
    //                 chassis_control.vx,
    //                 chassis_control.vy,
    //                 chassis_control.wz_set);

    // 调试陀螺仪补正
    // uart_dma_printf(&huart1, "%4.3f,%4.3f ,%4.3f, %4.3f\n",
    //                 ops9_data.yaw,
    //                 chassis_control.ops9_pos_y_set,
    //                 ops9_data.pos_x,
    //                 ops9_data.pos_y);
