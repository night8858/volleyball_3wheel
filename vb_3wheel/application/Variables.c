...
kalman1_state s_kalman1_hik_x; //卡尔曼滤波器_海康x数据
kalman1_state s_kalman1_hik_y; //卡尔曼滤波器_海康x数据

/********************************** PID variable ****************************************/
s_pid_absolute_t volleyball_track_far_PID_pos;          //排球远处定位跟踪PID结构体，位置环，击球杆处相机排球位置为参考数据
s_pid_absolute_t volleyball_track_far_PID_speed;        //排球远处定位跟踪PID结构体，速度环，车辆y速度为参考数据

s_pid_absolute_t volleyball_track_close_PID_pos;        //排球近处定位跟踪PID结构体，位置环，球拍下相机排球位置为参考数据
